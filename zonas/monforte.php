<?php
$zona_nombre  = "Monforte del Cid";
$zona_slug    = "monforte";
$zona_cp      = "03670";

$meta_title   = "Fontanería en Monforte del Cid — CarolTemp";
$meta_desc    = "Servicios de fontanería en Monforte del Cid. Consulta todos los trabajos disponibles: reparaciones, fugas, desatascos, instalaciones y reformas en tu zona.";
$meta_url     = "https://caroltemp.com/zonas/monforte";
$schema_type  = "zona";
$page_css     = "zona";
$page_js      = "zona";
    ...
    <div class="zona-tcol">
      <div>
        ...
        <div class="zona-prose">
          <p><?php echo $zona_nombre; ?> tiene muchas urbanizaciones y viviendas relativamente modernas, muchas de ellas como segunda residencia. Aunque las instalaciones suelen ser más recientes que en otros pueblos, es bastante habitual encontrar problemas de presión o suministro, sobre todo en urbanizaciones.</p>
          <p>Trabajamos en <?php echo $zona_nombre; ?> y La Romana, cubriendo tanto el casco urbano como todas las urbanizaciones y viviendas del término municipal. En esta página puedes ver todos los servicios disponibles y acceder al detalle de cada uno según lo que necesites.</p>
        </div>
        <ul class="zona-chk">
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Servicios de fontanería en <?php echo $zona_nombre; ?> para viviendas y urbanizaciones</li>
          ...
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Soluciones adaptadas a instalaciones modernas y segundas residencias</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Atención rápida en <?php echo $zona_nombre; ?> y La Romana</li>
      ...
      <div>
        <div class="zona-icard">
          ...
          <div class="zona-ir"><span class="zona-ir-l">Zona</span><span class="zona-ir-v"><?php echo $zona_nombre; ?> · La Romana · CP <?php echo $zona_cp; ?></span></div>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <div class="zona-svc">
      <a href="<?php echo $base_url; ?>fontanero/fontanero-monforte" class="zona-sc"><span class="zona-sc-n">01</span><h3>Reparaciones urgentes en <?php echo $zona_nombre; ?></h3><p>Fugas de agua, grifos, cisternas y tuberías con solución rápida y precio cerrado.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-monforte" class="zona-sc"><span class="zona-sc-n">02</span><h3>Detección de fugas en <?php echo $zona_nombre; ?></h3><p>Localización de fugas con geófono y cámara, sin romper innecesariamente.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>desatascos/desatascos-monforte" class="zona-sc"><span class="zona-sc-n">03</span><h3>Desatascos en <?php echo $zona_nombre; ?></h3><p>Desatascos de fregaderos, bajantes y arquetas para recuperar el funcionamiento normal.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>servicios#termos" class="zona-sc"><span class="zona-sc-n">04</span><h3>Termos eléctricos en <?php echo $zona_nombre; ?></h3><p>Instalación de termos eléctricos con asesoramiento y puesta en marcha.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>servicios#descalcificadores" class="zona-sc"><span class="zona-sc-n">05</span><h3>Descalcificadores en <?php echo $zona_nombre; ?></h3><p>Solución para el agua dura con instalación y mantenimiento de descalcificadores.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>servicios#reformas" class="zona-sc"><span class="zona-sc-n">06</span><h3>Reformas de baño en <?php echo $zona_nombre; ?></h3><p>Reformas completas o parciales con precio cerrado antes de empezar.</p><span class="zona-sc-a">Ver servicio →</span></a>
    </div>
  </div>
</section>
    ...
    <div class="zona-fugas">
      <div class="fg-top">
        <div>
          ...
          <p>Localizamos fugas de agua en <?php echo $zona_nombre; ?> y La Romana sin necesidad de romper paredes ni levantar suelos. Utilizamos tecnología profesional para encontrar el punto exacto de la fuga con la mínima intervención.</p>
        </div>
        <div>
          <ul class="fg-chk">
            ...
            <li>Fugas en tuberías y redes de agua</li>
            <li>Fugas en comunidades y urbanizaciones</li>
            <li>Localización precisa sin obras innecesarias</li>
          </ul>
          <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-monforte" class="fg-btn">Ver detalle completo →</a>
        </div>
      </div>
      <div class="fg-cards">
        <div class="fg-card">
          ...
          <p>El geófono detecta el sonido del agua al escapar por fisuras en tuberías. Permite localizar la fuga exacta sin necesidad de abrir.</p>
        </div>
        <div class="fg-card">
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <p class="zona-sub">Trabajos reales de fontanería en <?php echo $zona_nombre; ?> y La Romana.</p>
    <div class="zona-ig">
      <?php
      $imgs = [
...
<section class="zona-sec">
  <div class="cta-dark-con">
    ...
    <div class="zona-faq" style="margin-top:2rem">
      ...
      <div class="zona-fi">
        <div class="zona-fiq" onclick="togFaq(this)"><span>¿Trabajáis en La Romana además de <?php echo $zona_nombre; ?>?</span><span class="zona-fiq-i"><svg viewBox="0 0 10 10" fill="none"><path d="M5 1v8M1 5h8" stroke-width="1.5" stroke-linecap="round"/></svg></span></div>
        <div class="zona-fia">Sí. Cubrimos todo el término municipal de <?php echo $zona_nombre; ?> incluyendo La Romana y todas las urbanizaciones del entorno.</div>
      </div>
      <div class="zona-fi">
        <div class="zona-fiq" onclick="togFaq(this)"><span>¿Cómo detectáis fugas sin romper en <?php echo $zona_nombre; ?>?</span><span class="zona-fiq-i"><svg viewBox="0 0 10 10" fill="none"><path d="M5 1v8M1 5h8" stroke-width="1.5" stroke-linecap="round"/></svg></span></div>
        <div class="zona-fia">Utilizamos geófono y cámara para localizar el punto exacto de la fuga antes de abrir, evitando obras innecesarias. <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-monforte">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
        ...
        <div class="zona-fia">Sí. Realizamos desatascos en <?php echo $zona_nombre; ?> de fregaderos, lavabos, bajantes y arquetas. <a href="<?php echo $base_url; ?>desatascos/desatascos-monforte">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
        <div class="zona-fiq" onclick="togFaq(this)"><span>¿Solucionáis problemas de presión en urbanizaciones?</span><span class="zona-fiq-i"><svg viewBox="0 0 10 10" fill="none"><path d="M5 1v8M1 5h8" stroke-width="1.5" stroke-linecap="round"/></svg></span></div>
        <div class="zona-fia">Sí. Es algo bastante habitual en <?php echo $zona_nombre; ?>. Detectamos el origen del problema y lo solucionamos con un enfoque técnico y precio cerrado.</div>
      </div>
      <div class="zona-fi">
