...
$meta_title   = "Fontanería en Petrer — CarolTemp";
$meta_desc    = "Servicios de fontanería en Petrer. Consulta todos los trabajos disponibles: reparaciones, fugas, desatascos, instalaciones y reformas en tu zona.";
$meta_url     = "https://caroltemp.com/zonas/petrer";
$schema_type  = "zona";
$page_css     = "zona";
$page_js      = "zona";
    ...
    <div class="zona-tcol">
      <div>
        ...
        <div class="zona-prose">
          <p><?php echo $zona_nombre; ?> combina zonas de vivienda antigua con barrios más modernos y zonas unifamiliares bien conservadas. Las instalaciones varían bastante según la zona, desde tuberías antiguas en el centro hasta instalaciones más actuales en zonas de expansión.</p>
          <p>Trabajamos en toda la localidad de <?php echo $zona_nombre; ?>, cubriendo tanto viviendas como comunidades. En esta página puedes ver todos los servicios disponibles y acceder al detalle de cada uno según lo que necesites.</p>
        </div>
        <ul class="zona-chk">
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Servicios de fontanería en <?php echo $zona_nombre; ?> para todo tipo de viviendas</li>
          ...
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Intervenciones adaptadas a instalaciones antiguas y modernas</li>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <div class="zona-svc">
      <a href="<?php echo $base_url; ?>fontanero/fontanero-petrer" class="zona-sc"><span class="zona-sc-n">01</span><h3>Reparaciones urgentes en <?php echo $zona_nombre; ?></h3><p>Fugas de agua, grifos, cisternas y tuberías con solución rápida y precio cerrado.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-petrer" class="zona-sc"><span class="zona-sc-n">02</span><h3>Detección de fugas en <?php echo $zona_nombre; ?></h3><p>Localización de fugas con geófono y cámara sin romper innecesariamente.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>desatascos/desatascos-petrer" class="zona-sc"><span class="zona-sc-n">03</span><h3>Desatascos en <?php echo $zona_nombre; ?></h3><p>Desatascos de fregaderos, bajantes y arquetas para recuperar el funcionamiento normal.</p><span class="zona-sc-a">Ver servicio →</span></a>
    ...
    <div class="zona-fugas">
      <div class="fg-top">
        <div>
          ...
          <p>Localizamos el origen exacto de cualquier fuga en <?php echo $zona_nombre; ?> sin necesidad de romper paredes ni levantar suelos. Utilizamos tecnología profesional para detectar el punto exacto con la mínima intervención.</p>
        </div>
        <div>
          <ul class="fg-chk">
            ...
            <li>Detección de fugas en piscinas</li>
            <li>Localización precisa sin obras innecesarias</li>
          </ul>
          <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-petrer" class="fg-btn">Ver detalle completo →</a>
        </div>
      </div>
      <div class="fg-cards">
        <div class="fg-card">
...
<section class="zona-sec">
  <div class="cta-dark-con">
    ...
    <div class="zona-faq" style="margin-top:2rem">
      ...
      <div class="zona-fi">
        <div class="zona-fiq" onclick="togFaq(this)"><span>¿Tenéis servicio urgente en <?php echo $zona_nombre; ?>?</span><span class="zona-fiq-i"><svg viewBox="0 0 10 10" fill="none"><path d="M5 1v8M1 5h8" stroke-width="1.5" stroke-linecap="round"/></svg></span></div>
        <div class="zona-fia">Sí. Atendemos urgencias en <?php echo $zona_nombre; ?> dentro del horario de servicio. Puedes llamarnos y nos desplazamos lo antes posible.</div>
      </div>
      <div class="zona-fi">
        ...
        <div class="zona-fia">Utilizamos geófono y cámara para localizar el punto exacto de la fuga antes de abrir, evitando obras innecesarias. <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-petrer">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
        ...
        <div class="zona-fia">Sí. Realizamos desatascos en <?php echo $zona_nombre; ?> de fregaderos, lavabos, bajantes y arquetas. <a href="<?php echo $base_url; ?>desatascos/desatascos-petrer">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
