...
$meta_title   = "Fontanería en Novelda — CarolTemp";
$meta_desc    = "Servicios de fontanería en Novelda. Consulta todos los trabajos disponibles: reparaciones, fugas, desatascos, instalaciones, bombas y reformas.";
$meta_url     = "https://caroltemp.com/zonas/novelda";
$schema_type  = "zona";
$page_css     = "zona";
$page_js      = "zona";
...
<section class="hz-dark">
  ...
  <div class="hz-dark-con">
    ...
    <p class="hz-dark-sub">Trabajamos en <?php echo $zona_nombre; ?> realizando todo tipo de servicios de fontanería. Accede a cada servicio para ver el detalle completo en tu zona.</p>
    ...
    <div class="zona-tcol">
      <div>
        ...
        <div class="zona-prose">
          <p>Trabajamos en <?php echo $zona_nombre; ?> realizando todo tipo de servicios de fontanería en viviendas, locales y fincas. Es una zona con instalaciones muy variadas, desde pisos en el núcleo urbano hasta casas de campo con sistemas propios de agua.</p>
        ...
        <ul class="zona-chk">
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Servicios de fontanería en <?php echo $zona_nombre; ?> para viviendas, locales y fincas</li>
          ...
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Instalaciones de bombas, depósitos y sistemas de presión</li>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <div class="zona-svc">
      <a href="<?php echo $base_url; ?>fontanero/fontanero-novelda" class="zona-sc"><span class="zona-sc-n">01</span><h3>Fontanero en <?php echo $zona_nombre; ?></h3><p>Fontanero en <?php echo $zona_nombre; ?> para reparaciones, instalaciones y trabajos habituales en viviendas.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-novelda" class="zona-sc"><span class="zona-sc-n">02</span><h3>Detección de fugas en <?php echo $zona_nombre; ?></h3><p>Detección de fugas en <?php echo $zona_nombre; ?> con herramientas específicas y sin obras innecesarias.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>desatascos/desatascos-novelda" class="zona-sc"><span class="zona-sc-n">03</span><h3>Desatascos en <?php echo $zona_nombre; ?></h3><p>Desatascos en <?php echo $zona_nombre; ?> y limpieza de tuberías para recuperar el funcionamiento normal.</p><span class="zona-sc-a">Ver servicio →</span></a>
    ...
    <div class="zona-fugas">
      <div class="fg-top">
        <div>
          ...
          <p>Localizamos el origen exacto de cualquier fuga en <?php echo $zona_nombre; ?> sin abrir paredes ni levantar suelos. Especialmente útil en casas de campo con instalaciones complejas o tuberías enterradas.</p>
        </div>
        <div>
          <ul class="fg-chk">
          ...
          <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-novelda" class="fg-btn">Ver detalle completo →</a>
        </div>
      </div>
      <div class="fg-cards">
        <div class="fg-card">
          ...
          <p>El geófono detecta el sonido del agua al escapar por fisuras. Ideal para tuberías enterradas en fincas y casas de campo de <?php echo $zona_nombre; ?>.</p>
        </div>
        <div class="fg-card">
  ...
  <div class="cta-dark-con">
    ...
    <div class="zona-faq" style="margin-top:2rem">
      <div class="zona-fi open">
        ...
        <div class="zona-fia">En CarolTemp siempre damos precio cerrado antes de empezar. Una reparación sencilla suele resolverse desde 60–80€. Para trabajos mayores el precio se cierra tras ver el trabajo.</div>
      </div>
      <div class="zona-fi">
        <div class="zona-fiq" onclick="togFaq(this)"><span>¿Trabajáis en casas de campo y fincas de <?php echo $zona_nombre; ?>?</span><span class="zona-fiq-i"><svg viewBox="0 0 10 10" fill="none"><path d="M5 1v8M1 5h8" stroke-width="1.5" stroke-linecap="round"/></svg></span></div>
        <div class="zona-fia">Sí. Tenemos experiencia en instalaciones rurales — depósitos, bombas de presión, pozos y sistemas propios de agua. Cubrimos tanto el núcleo urbano de <?php echo $zona_nombre; ?> como todas las fincas y casas de campo de los alrededores.</div>
      </div>
      <div class="zona-fi">
        ...
        <div class="zona-fia">Usamos geófono y cámara endoscópica. El geófono detecta el sonido del agua al escapar por fisuras en tuberías enterradas. La cámara inspecciona el interior de tuberías y bajantes. Localizamos la fuga exacta antes de abrir nada. <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-novelda">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
