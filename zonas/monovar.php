...
<section class="hz-dark">
  ...
  <div class="hz-dark-con">
    ...
    <p class="hz-dark-sub">Trabajamos en <?php echo $zona_nombre; ?> y Monóver realizando todo tipo de servicios de fontanería. Accede a cada servicio para ver el detalle y cómo trabajamos en tu zona.</p>
    ...
    <div class="zona-tcol">
      <div>
        ...
        <div class="zona-prose">
          <p><?php echo $zona_nombre; ?> combina viviendas en el casco urbano con muchas casas de campo y zonas rurales alrededor. Es muy habitual encontrar instalaciones con depósitos, grupos de presión y sistemas propios de agua, especialmente fuera del núcleo urbano.</p>
          <p>Trabajamos en <?php echo $zona_nombre; ?> adaptándonos a cada tipo de instalación, ya sea en pisos, viviendas unifamiliares o fincas. En esta página puedes ver todos los servicios disponibles en tu zona y acceder al detalle de cada uno.</p>
        </div>
        <ul class="zona-chk">
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Servicios de fontanería en <?php echo $zona_nombre; ?> para viviendas, locales y casas de campo</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Reparaciones, instalaciones y mantenimiento completo</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Trabajos en depósitos, grupos de presión y sistemas de agua propios</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Atención rápida en <?php echo $zona_nombre; ?> y Monóver</li>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <div class="zona-svc">
      <a href="<?php echo $base_url; ?>fontanero/fontanero-monovar" class="zona-sc"><span class="zona-sc-n">01</span><h3>Reparaciones urgentes en <?php echo $zona_nombre; ?></h3><p>Fugas de agua, grifos, cisternas y tuberías en <?php echo $zona_nombre; ?> con solución rápida y precio cerrado.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-monovar" class="zona-sc"><span class="zona-sc-n">02</span><h3>Detección de fugas en <?php echo $zona_nombre; ?></h3><p>Localización de fugas en <?php echo $zona_nombre; ?> con geófono y cámara, sin romper innecesariamente.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>desatascos/desatascos-monovar" class="zona-sc"><span class="zona-sc-n">03</span><h3>Desatascos en <?php echo $zona_nombre; ?></h3><p>Desatascos de fregaderos, bajantes y arquetas en <?php echo $zona_nombre; ?> para recuperar el funcionamiento normal.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>servicios#bombas" class="zona-sc"><span class="zona-sc-n">04</span><h3>Depósitos y grupos de presión en <?php echo $zona_nombre; ?></h3><p>Instalación y mantenimiento de depósitos y sistemas de presión para viviendas de campo.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>servicios#descalcificadores" class="zona-sc"><span class="zona-sc-n">05</span><h3>Descalcificadores en <?php echo $zona_nombre; ?></h3><p>Solución para el agua dura de <?php echo $zona_nombre; ?> con instalación y mantenimiento de descalcificadores.</p><span class="zona-sc-a">Ver servicio →</span></a>
    ...
    <div class="zona-fugas">
      <div class="fg-top">
        <div>
          ...
          <p>Localizamos fugas de agua en <?php echo $zona_nombre; ?> y Monóver sin necesidad de romper paredes ni levantar suelos. Utilizamos tecnología de detección para encontrar el punto exacto del problema.</p>
        </div>
        <div>
          <ul class="fg-chk">
            <li>Detección de fugas de agua en viviendas en <?php echo $zona_nombre; ?></li>
            <li>Fugas de agua urgentes en <?php echo $zona_nombre; ?> y Monóver</li>
            <li>Fugas en tuberías y bajantes</li>
            <li>Fugas en comunidades de vecinos</li>
            <li>Fugas en piscinas</li>
            <li>Localización precisa sin obras innecesarias</li>
          </ul>
          <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-monovar" class="fg-btn">Ver detalle completo →</a>
        </div>
      </div>
      <div class="fg-cards">
        <div class="fg-card">
          ...
          <p>El geófono detecta el sonido del agua al escapar por fisuras en tuberías. Permite localizar fugas sin abrir paredes, especialmente útil en instalaciones enterradas.</p>
        </div>
        <div class="fg-card">
  ...
  <div class="cta-dark-con">
    ...
    <div class="zona-faq" style="margin-top:2rem">
      ...
      <div class="zona-fi">
        ...
        <div class="zona-fia">Sí. <?php echo $zona_nombre; ?> y Monóver hacen referencia al mismo municipio. Cubrimos tanto el casco urbano como todas las zonas rurales y partidas.</div>
      </div>
      <div class="zona-fi">
        ...
        <div class="zona-fia">Utilizamos geófono y cámara. Localizamos el punto exacto de la fuga antes de abrir, evitando obras innecesarias. <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-monovar">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
        ...
        <div class="zona-fia">Sí. Realizamos desatascos en <?php echo $zona_nombre; ?> de fregaderos, lavabos, bajantes y arquetas. <a href="<?php echo $base_url; ?>desatascos/desatascos-monovar">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
        <div class="zona-fiq" onclick="togFaq(this)"><span>¿Instaláis depósitos y grupos de presión en <?php echo $zona_nombre; ?>?</span><span class="zona-fiq-i"><svg viewBox="0 0 10 10" fill="none"><path d="M5 1v8M1 5h8" stroke-width="1.5" stroke-linecap="round"/></svg></span></div>
        <div class="zona-fia">Sí. Trabajamos habitualmente en viviendas de campo con depósitos y sistemas de presión. Adaptamos cada instalación a la vivienda.</div>
      </div>
      <div class="zona-fi">
