...
$meta_title   = "Fontanería en Salinas — CarolTemp";
$meta_desc    = "Servicios de fontanería en Salinas. Consulta todos los trabajos disponibles: reparaciones, fugas, desatascos, instalaciones y reformas en tu zona.";
$meta_url     = "https://caroltemp.com/zonas/salinas";
$schema_type  = "zona";
$page_css     = "zona";
$page_js      = "zona";
    ...
    <div class="zona-tcol">
      <div>
        ...
        <div class="zona-prose">
          <p><?php echo $zona_nombre; ?> es un municipio pequeño y con bastante vivienda antigua, donde es habitual encontrar instalaciones sencillas pero envejecidas. Muchas viviendas han ido acumulando pequeñas reformas con el tiempo, lo que genera instalaciones mezcladas que requieren experiencia para trabajar correctamente.</p>
          <p>Trabajamos en <?php echo $zona_nombre; ?> y Salines d'Elda, cubriendo tanto el casco urbano como las zonas rurales del municipio. En esta página puedes ver todos los servicios disponibles y acceder al detalle de cada uno según lo que necesites.</p>
        </div>
        <ul class="zona-chk">
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Servicios de fontanería en <?php echo $zona_nombre; ?> para viviendas y casas de campo</li>
          ...
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Soluciones adaptadas a instalaciones antiguas</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Atención rápida en <?php echo $zona_nombre; ?> y alrededores</li>
      ...
      <div>
        <div class="zona-icard">
          ...
          <div class="zona-ir"><span class="zona-ir-l">Zona</span><span class="zona-ir-v"><?php echo $zona_nombre; ?> · Salines d'Elda · CP <?php echo $zona_cp; ?></span></div>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <div class="zona-svc">
      <a href="<?php echo $base_url; ?>fontanero/fontanero-salinas" class="zona-sc"><span class="zona-sc-n">01</span><h3>Reparaciones urgentes en <?php echo $zona_nombre; ?></h3><p>Fugas de agua, grifos, cisternas y tuberías en <?php echo $zona_nombre; ?> con solución rápida y precio cerrado.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-salinas" class="zona-sc"><span class="zona-sc-n">02</span><h3>Detección de fugas en <?php echo $zona_nombre; ?></h3><p>Localización de fugas en <?php echo $zona_nombre; ?> con geófono y cámara, sin romper innecesariamente.</p><span class="zona-sc-a">Ver servicio →</span></a>
      <a href="<?php echo $base_url; ?>desatascos/desatascos-salinas" class="zona-sc"><span class="zona-sc-n">03</span><h3>Desatascos en <?php echo $zona_nombre; ?></h3><p>Desatascos de fregaderos, bajantes y arquetas en <?php echo $zona_nombre; ?> para recuperar el funcionamiento normal.</p><span class="zona-sc-a">Ver servicio →</span></a>
    ...
    <div class="zona-fugas">
      <div class="fg-top">
        <div>
          ...
          <p>Localizamos fugas de agua en <?php echo $zona_nombre; ?> sin necesidad de romper paredes ni levantar suelos. Es especialmente útil en casas antiguas donde las tuberías no siempre están visibles o bien ubicadas.</p>
        </div>
        <div>
          <ul class="fg-chk">
            ...
            <li>Fugas en tuberías antiguas</li>
            <li>Fugas en viviendas rurales</li>
            <li>Localización precisa sin obras innecesarias</li>
          </ul>
          <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-salinas" class="fg-btn">Ver detalle completo →</a>
        </div>
      </div>
      <div class="fg-cards">
        <div class="fg-card">
...
<section class="zona-sec">
  <div class="cta-dark-con">
    ...
    <div class="zona-faq" style="margin-top:2rem">
      ...
      <div class="zona-fi">
        <div class="zona-fiq" onclick="togFaq(this)"><span>¿Trabajáis en Salines d'Elda además de <?php echo $zona_nombre; ?>?</span><span class="zona-fiq-i"><svg viewBox="0 0 10 10" fill="none"><path d="M5 1v8M1 5h8" stroke-width="1.5" stroke-linecap="round"/></svg></span></div>
        <div class="zona-fia">Sí. <?php echo $zona_nombre; ?> y Salines d'Elda son el mismo municipio en castellano y valenciano. Cubrimos todo el término municipal, incluyendo zonas rurales.</div>
      </div>
      <div class="zona-fi">
        ...
        <div class="zona-fia">Utilizamos geófono y cámara. Localizamos el punto exacto de la fuga antes de abrir, evitando obras innecesarias. <a href="<?php echo $base_url; ?>fugas/deteccion-fugas-salinas">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
        ...
        <div class="zona-fia">Sí. Realizamos desatascos en <?php echo $zona_nombre; ?> de fregaderos, lavabos, bajantes y arquetas. <a href="<?php echo $base_url; ?>desatascos/desatascos-salinas">Ver detalle completo →</a></div>
      </div>
      <div class="zona-fi">
        <div class="zona-fiq" onclick="togFaq(this)"><span>¿Tenéis fontanero urgente en <?php echo $zona_nombre; ?>?</span><span class="zona-fiq-i"><svg viewBox="0 0 10 10" fill="none"><path d="M5 1v8M1 5h8" stroke-width="1.5" stroke-linecap="round"/></svg></span></div>
        <div class="zona-fia">Sí. Atendemos urgencias en <?php echo $zona_nombre; ?> en horario de servicio y llegamos rápido al ser de la zona.</div>
      </div>
      <div class="zona-fi">
