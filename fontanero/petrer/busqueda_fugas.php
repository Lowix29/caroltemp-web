...
<section class="hz-dark">
  ...
  <div class="hz-dark-con">
    ...
    <h1>Detección de fugas en Petrer<br><span class="hl">sin abrir hasta confirmar el punto exacto</span></h1>
    ...
    <div class="zona-tcol">
      <div>
        ...
        <ul class="zona-chk">
          ...
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas en instalaciones de agua en adosados</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas en tuberías enterradas o empotradas</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas en comunidades de vecinos (bajantes, arquetas)</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas ocultas en circuitos de calefacción</li>
        </ul>
      </div>
      <div>
        <div class="zona-icard">
          <div class="zona-icard-h"><strong>CarolTemp &middot; Petrer</strong><span>Búsqueda de fugas</span></div>
          ...
          <div class="zona-ir"><span class="zona-ir-l">Todos los servicios</span><span class="zona-ir-v"><a href="/fontanero/petrer">Fontaner&iacute;a en Petrer &rarr;</a></span></div>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <h2>Por qu&eacute; nos llaman por Búsqueda de fugas <span class="hl">en Petrer</span></h2>
    <div class="zona-svc">
      <div class="zona-sc">
        <h3>Agua muy dura que daña juntas y válvulas</h3>
        <p>Petrer tiene agua con alta concentración de cal. Los termos, calentadores y grifos acumulan depósitos que corroen juntas y válvulas, provocando fugas lentas en roscas y conexiones. CarolTemp revisa la instalación completa y localiza el punto exacto.</p>
      </div>
      <div class="zona-sc">
        <h3>Tuberías antiguas en urbanizaciones de los 80-90</h3>
...
<section class="zona-sec">
  <div class="cta-dark-con">
    ...
    <h2>Proyectos de Búsqueda de fugas <span class="hl">en Petrer</span></h2>
...
<section class="zona-sec">
  <div class="cta-dark-con">
    ...
    <h2>Búsqueda de fugas <span class="hl">en Petrer</span></h2>
    ...
    <div style="border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,.12)">
      <iframe src="https://maps.google.com/maps?q=38.4697,-0.7742&z=14&output=embed" width="100%" height="380" style="border:0;display:block" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Búsqueda de fugas en Petrer"></iframe>
    </div>
  </div>
</section>
<section class="zona-sec zona-sec-gray">
...
<section class="cta-dark">
  <div class="cta-dark-con">
    <h2>&iquest;Necesitas Búsqueda de fugas <span>en Petrer?</span></h2>
