...
<section class="hz-dark">
  ...
  <div class="hz-dark-con">
    ...
    <h1>Detección de fugas en Salinas<br><span class="hl">localizada con informe para el seguro</span></h1>
    ...
    <div class="zona-tcol">
      <div>
        ...
        <ul class="zona-chk">
          ...
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas en tuberías antiguas de hierro galvanizado</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas de agua en comunidades de vecinos en Salinas</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas en acometidas exteriores y jardines de chalets</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas de agua urgentes con avería activa en Salinas</li>
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Fugas bajo solería o en tuberías de suelo radiante</li>
        </ul>
      </div>
      <div>
        <div class="icard">
...
<section class="zona-sec zona-sec-alt">
  <div class="cta-dark-con">
    ...
    <h2>Fugas de agua en Salinas <span class="hl">por tipo de instalación</span></h2>
    <div class="zona-grid-6">
      ...
      <div class="zona-tipo">
        ...
        <p>Circuitos de caldera, radiadores y suelo radiante. La cámara termográfica localiza el punto sin vaciar el sistema. Eficaz en viviendas con calefacción central y suelo radiante.</p>
      </div>
      <div class="zona-tipo">
        <div class="zona-tipo-ico">🏠</div>
      ...
      <div class="zona-tipo">
        ...
        <p>Fugas en columnas generales, bajantes y zonas comunes de comunidades en Salinas. Localización precisa para atribuir la responsabilidad antes de abrir cualquier elemento común.</p>
      </div>
      <div class="zona-tipo">
        <div class="zona-tipo-ico">📋</div>
        <h3>Informe para seguro</h3>
        <p>Emitimos informe técnico con descripción de la fuga, método de detección y punto exacto localizado. Documento válido para presentar a la aseguradora junto con el parte de siniestro.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="zona-sec">
  <div class="cta-dark-con">
    ...
    <h2>Proceso de localización <span class="hl">de fugas en Salinas</span></h2>
    <div class="zona-steps">
      ...
      <div class="zona-step">
        ...
        <div class="zona-step-txt">
          ...
          <p>La cámara muestra en imagen las diferencias de temperatura que provoca la humedad. Especialmente eficaz en fugas de calefacción y suelo radiante: el circuito caliente deja una huella térmica clara en suelo y pared. Cuando geófono y termografía coinciden, la localización es fiable.</p>
        </div>
      </div>
      <div class="zona-step">
        ...
        <div class="zona-step-txt">
          ...
          <p>Marcamos físicamente el punto exacto en el suelo o la pared. Damos presupuesto de reparación y apertura antes de tocar nada. La detección de fugas de agua en Salinas ya está hecha — tú decides si seguimos.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <h2>Precio detección de fugas <span class="hl">Salinas</span></h2>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <h2>Proyectos de b&uacute;squeda de fugas <span class="hl">en Salinas</span></h2>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <div style="border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,.12)">
      <iframe src="https://maps.google.com/maps?q=38.5009,-0.8536&z=14&output=embed" width="100%" height="380" style="border:0;display:block" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Detección fugas Salinas"></iframe>
    </div>
  </div>
</section>
<section class="zona-sec">
...
<section class="cta-dark">
  <div class="cta-dark-con">
    <h2>&iquest;Sospechas de una fuga <span>en Salinas?</span></h2>
