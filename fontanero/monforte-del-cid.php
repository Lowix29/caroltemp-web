...
<section class="zona-sec">
  <div class="cta-dark-con">
    ...
    <div class="zona-svc" style="margin-top:2rem">
      ...
      <a href="/fontanero/monforte-del-cid/urgencias" class="zona-sc">
        <span class="zona-sc-n">URGENCIAS</span>
        <h3>Fontanero urgente Monforte del Cid</h3>
      ...
      <a href="/fontanero/monforte-del-cid/busqueda-fugas" class="zona-sc">
        <span class="zona-sc-n">FUGAS</span>
        <h3>Detección de fugas en Monforte del Cid</h3>
        <p>Localización de fugas de agua en Monforte del Cid sin romper paredes: geófono y cámara termográfica. Marcamos el punto exacto antes de abrir.</p>
        <span class="zona-sc-a">Ver fugas &rarr;</span>
      </a>

      <a href="/fontanero/monforte-del-cid/desatascos" class="zona-sc">
        <span class="zona-sc-n">DESATASCOS</span>
        <h3>Desatascos en Monforte del Cid</h3>
      ...
      <div class="zona-sc">
        ...
        <p>El agua dura de Monforte del Cid destruye la resistencia del termo en pocos años. Reparación o sustitución con presupuesto previo y sin visita extra.</p>
      </div>

      <div class="zona-sc">
        <span class="zona-sc-n">REFORMAS</span>
        <h3>Reformas de baño y cocina</h3>
        <p>Reforma completa o parcial de la instalación de fontanería en Monforte del Cid. Sustitución de tuberías, traslado de puntos de agua y adecuación a normativa.</p>
      </div>

      <div class="zona-sc">
        <span class="zona-sc-n">DESCALCIFICADORES</span>
        <h3>Descalcificadores</h3>
        <p>El agua de la comarca del Vinalopó tiene dureza elevada. Un descalcificador bien dimensionado protege termos, calentadores y electrodomésticos de toda la vivienda.</p>
      </div>
...
<section class="zona-sec zona-sec-alt">
  <div class="cta-dark-con">
    <div class="zona-tcol">
      <div>
        <p class="zona-lbl">Por qué Monforte del Cid es exigente con la fontanería</p>
        <h2>El agua dura del Vinalopó <span class="hl">y lo que hace a tus tuberías</span></h2>
        <div class="zona-prose">
          <p>Monforte del Cid, como el resto de municipios de la comarca del Vinalopó Medio, tiene un agua con dureza alta. El sarro se acumula en el interior de termos y calentadores, reduce el caudal en tuberías de pequeño diámetro y deteriora las juntas de latón mucho antes de lo que debería. Lo que en otras zonas dura 15 años, aquí puede requerir atención a los 8-10.</p>
          <p>Esto afecta directamente a la <strong>fontanería en Monforte del Cid</strong>: las urgencias por termo averiado son proporcionalmente más frecuentes que en zonas con agua blanda, y las fugas de agua en calefacción y suelo radiante aparecen antes porque las juntas se resecan con la cal. Un descalcificador bien dimensionado es la mejor inversión que puede hacer una vivienda en Monforte del Cid.</p>
        </div>
        <ul class="zona-chk">
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Termos que duran menos por la cal del agua</li>
          ...
          <li><span class="chk-ico"><svg viewBox="0 0 10 10" fill="none" width="10" height="10"><path d="M1.5 5l2.5 2.5 4.5-4.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Electrodomésticos que consumen más energía con cal</li>
        </ul>
      </div>
      <div>
        <div class="zona-icard">
          ...
          <div class="zona-ir"><span class="zona-ir-l">Cobertura</span><span class="zona-ir-v">Casco urbano y viñedos</span></div>
  ...
  <div class="cta-dark-con">
    ...
    <div class="zona-faqs">
      ...
      <details class="zona-faq-item">
        ...
        <div class="faq-ans">Sí. Cubrimos todo el término municipal de Monforte del Cid: casco urbano, urbanizaciones y explotaciones agrícolas. Las instalaciones de riego y fontanería en bodegas y viñedos también las atendemos — avisad indicando el tipo de instalación para llevar el material adecuado.</div>
      </details>
      <details class="zona-faq-item">
      ...
      <details class="zona-faq-item">
        ...
        <div class="faq-ans">Sí. Realizamos la sustitución completa de tuberías de suministro y saneamiento, traslado de puntos de agua, adecuación de instalaciones antiguas a normativa y montaje de baños y cocinas. Presupuesto gratuito a domicilio.</div>
      </details>
    </div>
  </div>
</section>
