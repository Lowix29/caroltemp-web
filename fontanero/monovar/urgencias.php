...
<section class="hz-dark">
  ...
  <div class="hz-dark-con">
    ...
    <h1>Fontanero urgente en Monóvar<br><span class="hl">disponibles 24 horas para resolver cualquier avería</span></h1>
...
<section class="zona-sec zona-sec-alt">
  <div class="cta-dark-con">
    ...
    <h2>Averías urgentes <span class="hl">en Monóvar</span></h2>
    <div class="zona-grid-6">
      <div class="zona-tipo">
        <div class="zona-tipo-ico">💧</div>
        <h3>Fugas de agua urgentes</h3>
        <p>Fugas de agua urgentes en tuberías de viviendas, fincas y locales en Monóvar. Localizamos y cerramos el escape antes de que cause daños en estructura o acabados.</p>
      </div>
      <div class="zona-tipo">
      ...
      <div class="zona-tipo">
        ...
        <p>Termo sin agua caliente, calentador que no enciende o caldera que falla. El agua dura de Monóvar acelera el deterioro de resistencias y válvulas de seguridad.</p>
      </div>
      <div class="zona-tipo">
        <div class="zona-tipo-ico">🔩</div>
        <h3>Roturas de tubería</h3>
        <p>Rotura de tubería empotrada o vista con agua a presión. Cortamos el paso, evaluamos el daño y presupuestamos la reparación antes de abrir ninguna pared.</p>
      </div>
      <div class="zona-tipo">
        <div class="zona-tipo-ico">🚰</div>
    ...
    <div class="zona-steps">
      <div class="zona-step">
        ...
        <div class="zona-step-txt">
          ...
          <p>Describes el problema por teléfono o WhatsApp. Te damos un precio orientativo según el tipo de avería y acordamos la visita. Si es una urgencia real en Monóvar, priorizamos el desplazamiento.</p>
        </div>
      </div>
      <div class="zona-step">
      ...
      <div class="zona-step">
        ...
        <div class="zona-step-txt">
          ...
          <p>Si hay material en la furgoneta, resolvemos en el mismo día. El precio final es el que se acordó, sin añadidos. La avería fontanería urgente en Monóvar no debería tener sorpresas — y no las tiene.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="zona-sec zona-sec-gray">
  <div class="cta-dark-con">
    ...
    <h2>Tarifas fontanero urgente <span class="hl">Monóvar</span></h2>
    ...
    <div class="zona-precios">
      ...
      <div class="zona-precio-row">
        <span class="zona-precio-concepto">Desplazamiento a Monóvar</span>
...
<section class="cta-dark">
  <div class="cta-dark-con">
    <h2>&iquest;Tienes una aver&iacute;a <span>en Mon&oacute;var?</span></h2>
